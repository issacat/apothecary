...
public class customerScript : MonoBehaviour
{
    ...
    public void setChara()
    {
        ...
        else if (charaState == 7) //fourth request start
        {
            ...
            dia.Add("Topka: But maybe if I can please Uuryn? A charm to make me seem <b>devastatingly attractive</b>?");
        ...
        else if (charaState == 11) // 6 SIXTH request start 
        {
            ...
            dia.Add("Yagi: You are perceptive. I am plagued by nightmares, yet wake in cold sweat without rememberence, left with only a nagging hole inside.");
